...
# ##############################################################################
#
# Script que crea un túnel para poder compartir online nuestro proyecto.
#
#  @version   v1.0.0
#  @license   GNU/GPL v3+
# ##############################################################################
...
linea
echo -e " ${GREEN}Script que crea un túnel para poder compartir online el proyecto.${RESET}"
linea
